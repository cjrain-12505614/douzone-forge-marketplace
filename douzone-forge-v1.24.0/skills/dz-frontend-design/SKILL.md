...
본 스킬로 작성되는 HTML 산출물에서도 `규칙/프로세스/공용-개인-경계-규칙.md`(forge) 및 PRJ 코드 표기 규칙 (CLAUDE.md "PRJ 코드 표기 규칙" 섹션) 준수. **PRJ 코드 단독 사용 금지** — 항상 프로젝트명과 함께 표기. 예: `Amaranth10-Claude-Forge 구축(PRJ-2026-014)`.
