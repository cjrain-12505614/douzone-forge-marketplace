---
name: dz-org-archive
description: "퇴사 인원 처리 — 조직/{...}/{이름_ID}/ → 조직/archived/{이름_ID}/ 이동 ({이름} 재확인 단계, 민감 정보 분리)"
version: 0.1.0
---

# /dz-org-archive 커맨드 (Phase Q-2 신설)

퇴사 인원 폴더를 `조직/archived/`로 이동. **{이름} 재확인 단계 의무** (D3 정책).

## 사용 시점

- xlsx에서 사라진 ID (dz-org-sync가 검출)
- 퇴사 통보 수령 후 admin 처리
