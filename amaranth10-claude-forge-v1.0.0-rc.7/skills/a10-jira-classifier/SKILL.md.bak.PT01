...
| `KLAGOP1-` | 기능개선/고도화 | `{모듈}/tasks/enhancements/` + `_projects/PRJ-*.md` | A10 통합 개발 |
| `A10D-` | 기능개선/고도화 | 동상 | A10 기능 고도화 (유지보수 이관 주 대상) |
| `UCAIMP-` | 기능개선/고도화 | 동상 | Alpha 패키지 고도화 |
| `BC10-` | 검수 | `{모듈}/tasks/검수/` | 릴리스 직전 통합 검수 이슈 |
| **기타/미매칭** | 미분류 | `_reports/unclassified-jira.md` | 경고 리포트만, 자동 라우팅 금지 |
...
- `_reports/unclassified-jira.md` 에 append만 수행
- 자동 라우팅·자동 파일 생성 **금지**
- PM이 수동으로 라우팅 결정
...
- 프리픽스 추가는 `douzone-forge/_참조자료/프로세스/깃-커밋-메시지-규약.md` 와 동기화 필요
