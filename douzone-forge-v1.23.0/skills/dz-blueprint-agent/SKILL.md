...
본 SKILL 은 `규칙/프로세스/에이전트-구성-역할-정의.md`(forge) SSoT §3 + `규칙/프로세스/개발설계-산출물-작성-표준.md`(forge)(D-08) 의 운영본이다.
...
- SSoT (표준 정의): `규칙/프로세스/에이전트-구성-역할-정의.md`(forge) §3 BLUEPRINT(#15) 행
- 산출물 표준 (D-08): `규칙/프로세스/개발설계-산출물-작성-표준.md`(forge)
