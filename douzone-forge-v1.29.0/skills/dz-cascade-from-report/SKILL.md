...
# 업무보고 Cascade (dz-cascade-from-report) — v2 받은보고함 워크플로우 정착
...
### 4. 본인 `_개인/sessions/{대상}/_current.md` 체크포인트
...
- 의존: `skills/dz-amalink-recursive-extract/` (S-07 신설 — 4건 룰 캡슐화)
...
- `프로젝트/_dashboard.md`
- `skills/dz-cascade-from-context/` (R-02)
- `skills/dz-cascade-from-prj/` (R-03)
- `skills/dz-amalink-recursive-extract/` (Phase S S-07 신설 — 재귀+댓글+헤더 캡슐화)
- `skills/dz-people-context/` (S-07 보강 — 본인 업무현황 lookup)
- `skills/dz-daily-digest/` — 일일보고 캐싱 (3-way 크로스 체크)
