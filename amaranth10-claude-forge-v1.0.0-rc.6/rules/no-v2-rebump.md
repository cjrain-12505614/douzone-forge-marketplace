---
name: no-v2-rebump
description: 차민수 단순 OK 시 즉시 진행. v2 계획서 갱신 시도 X. v1 그대로 + 정정 1~2건만 본문 반영.
...
차민수 단순 OK 또는 ExitPlanMode 승인 후, 같은 사이클 내 v2 계획서 신규 작성을 금지한다. v1 파일을 그대로 두고 정정 1~2건만 본문 반영한다.

### 적용 분기

| 상황 | 처리 |
|---|---|
| 차민수 단순 OK 채팅 | Code 즉시 ⑦ 적용 진입 |
...
- 자비스 ⑦ Code 적용 절차 — SSoT §3 워크플로우 10단계
