...
- **PoC 원본**: `프로젝트/PRJ-2026-012_업무관리-프로젝트관리-기능확장/05_산출물/p1-research/jira-integration/amaranth10-jira-collector.tar.gz`(forge)
- **운영 가이드**: `프로젝트/PRJ-2026-012_업무관리-프로젝트관리-기능확장/05_산출물/p1-research/jira-integration/jira-integration-guide.html`(forge)
- **PoC 해설 (forge)**: `프로젝트/PRJ-2026-012_업무관리-프로젝트관리-기능확장/05_산출물/p1-research/jira-integration/README.md`(forge)
- **프로젝트 상세**: `프로젝트/PRJ-2026-012_업무관리-프로젝트관리-기능확장/00_overview.md`(forge)
...
**단일 원천 (Single Source of Truth)**: `참고자료/조직정보/더존비즈온-조직구조.md`(forge) 의 각 Cell 표에서 **이름 옆 괄호 안의 ID**가 곧 JIRA ID이며, 사내 이메일 프리픽스(`{id}@douzone.com`)와 동일하다.
