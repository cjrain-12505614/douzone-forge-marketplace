...
| 의사결정 범위 | 저장 위치 |
|-------------|---------|
| 프로젝트 특정 | `프로젝트/PRJ-*.md`의 `01. D. 이슈 & 리스크` + `03. 상세 진행현황` |
...
| 등급 | 의미 | 결정자 | 예시 |
|------|------|--------|------|
| 🔴 | PM 컨펌 필수 | PM ({이름}) | 전략 방향, 기능 범위, 우선순위, 일정 변경 |
...
### 새 결정 기록 시
1. 관련 프로젝트 파일 `프로젝트/PRJ-*.md`를 찾는다.
...
### 미결 사항 조회
- `프로젝트/_dashboard.md`에서 리스크가 있는 프로젝트를 확인한다.
