...
description: "_개인/ 골격 + 자기 조직 폴더 4계층 자동 lookup (xlsx 13번 ID) + _index.md 자동 채움 + 본인 R&R 자동 정착 + 직책 체크 시 팀트래킹 신설 + .gitignore"
version: 0.4.0
---

# /a10-personal-init 커맨드 (Phase Q-2 v0.3.0 + Phase V V-07-04 v0.4.0 확장)
...
5. **본인 R&R 자가 확보** — xlsx 13번 동적 lookup 결과를 `_개인/{본인이름_사번}/_R&R.md` 본문에 박음. 일일보고·a10-people-context 등 후속 스킬이 본 메타 파일을 lookup하여 본인 부하 직원 명단 자동 식별.
...
a10-people-index Skill을 호출하여 본인 ID 기반 다음 메타 자가 확보:
- 본인 한글 이름
- 본인 사번 (xlsx 22번)
...
## 6. 변천사
- YYYY-MM-DD — a10-personal-init v0.4.0 자동 정착
```
...
- **a10-people-context** — 본인 종합 현황 lookup 시 `_개인/{본인이름_사번}/_R&R.md` 우선 참조 (xlsx 직접 lookup 대체)
- **a10-cascade-from-report** — 일일보고 보고 대상 자동 식별 시 본 메타 §4 "부하 직원" 섹션 사용
- **a10-personal-tracking** — 트래킹 노트 작성 시 본 메타 §4 부하 직원 ID 매핑
...
✅ _개인/{본인이름_사번}/_R&R.md 본인 R&R 메타 신설 완료:
  ...
  - 후속 스킬(a10-people-context·a10-cascade-from-report·a10-personal-tracking) lookup 의존
...
- /a10-people-context 본인 종합 현황 첫 호출 — _R&R.md 정합 검증
```
