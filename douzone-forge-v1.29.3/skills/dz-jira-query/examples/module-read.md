...
|-----|------|---------|------|-------|------|---------|
| CSA10-1234 | Bug  | High   | In Progress | {이름} | 업무 목록 페이징 오류 | 2026-04-17 |
| CSA10-1235 | Task | Medium | To Do       | {이름} | 필터 UI 개선       | 2026-04-16 |
| ...
```
...
입력: `/dz-jira --read 2025-12-31/업무관리`
