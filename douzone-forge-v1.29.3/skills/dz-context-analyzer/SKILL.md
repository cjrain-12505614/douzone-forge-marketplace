...
description: >
  ...
  douzone-forge 컨텍스트 파일로 변환을 요청할 때.
...
douzone-forge GNB/LNB 컨텍스트 파일 형식으로 자동 변환한다.
...
**R2 — 관련 프로젝트 연결 정보 확인:**
1. `프로젝트/_dashboard.md`에서 해당 모듈과 관련된 PRJ 파일을 확인
...
- 생성 파일 형식: `references/output-format.md` (_overview.md·LNB 상세 골격 포함)
