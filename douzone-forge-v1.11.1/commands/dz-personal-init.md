...
description: "_개인/ 골격 + 자기 조직 폴더 4계층 자동 lookup (xlsx 13번 ID) + _index.md 자동 채움 + 본인 R&R 자동 정착 + 본인 부서 맥락 진입점 자동 정착 + 직책 체크 시 팀트래킹 신설 + .gitignore + git 신원(Amaranth 10 ID)·core.hooksPath 자동 + MCP(jira·a10) 등록·⛔인증 게이트(건너뛰기 금지 — jira 편집기 입력 안내·a10 크롬 자동 시드 자비스 주도) (v0.10.0)"
version: 0.10.0
---
