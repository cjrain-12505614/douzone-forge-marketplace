...
**단일 원천 (Single Source of Truth)**: [`_참조자료/조직/더존비즈온-조직구조.md`](../../../../douzone-forge/_참조자료/조직/더존비즈온-조직구조.md) 의 각 Cell 표에서 **이름 옆 괄호 안의 ID**가 곧 JIRA ID이며, 사내 이메일 프리픽스(`{id}@douzone.com`)와 동일하다.
...
담당자 JIRA ID가 필요할 때:
1. 사용자에게 묻지 말고 먼저 `_참조자료/조직/더존비즈온-조직구조.md` 에서 이름으로 Grep
