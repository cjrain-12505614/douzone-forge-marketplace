...
- `Amaranth10/법무관리(LTE)/소송관리` → 위 + 소송관리/_overview.md 로드
- `Amaranth10/법무관리(LTE)/소송관리/소송등록` → 위 + 소송관리/소송등록.md 로드
...
1. `./context/$ARGUMENTS`
2. `./$ARGUMENTS`
3. `~/douzone-forge-data/$ARGUMENTS`
...
`/dz-feature-spec` 또는 context-manager 스킬로 생성할 수 있다고 안내한다.
