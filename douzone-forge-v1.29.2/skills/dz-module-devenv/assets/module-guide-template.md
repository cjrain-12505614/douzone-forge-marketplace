...
yarn autoClone
SKILL=~/.claude/plugins/cache/douzone-forge-marketplace/douzone-forge/*/skills/dz-module-devenv
bash "$SKILL"/scripts/resolve-undeclared-deps.sh   # 미선언 의존 자동 해소
yarn install --ignore-engines
bash "$SKILL"/scripts/fix-node-sass.sh             # node-sass→dart-sass(Apple Silicon)
yarn packages
