---
name: dz-org-bootstrap
description: "admin 첫 도입 시 1회 — Beta 사용자 부서 + 직속 상위 부서 폴더 신설 (사내 일괄 생성 금지, 멱등성 보장)"
version: 0.1.0
---

# /dz-org-bootstrap 커맨드 (Phase Q-2 신설)

admin ({이름}) 첫 도입 시 1회 — Beta 사용자가 진입하기 전 조직 폴더 골격을 점진 신설.
...
✅ admin bootstrap 완료
  ...
  - 다음: Beta 사용자 진입 시 dz-personal-init 자가 실행
```

## 의존 자산

- `skills/dz-people-index/SKILL.md` (G8) — ID 매핑 조회
- `참고자료/조직정보/*.xlsx` — SSoT
