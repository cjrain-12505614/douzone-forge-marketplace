...
1. `_projects/_dashboard.md` — 전체 프로젝트 포트폴리오 (진행률, 상태, 리스크)
2. 진행 중 프로젝트의 `_projects/PRJ-*.md` — TASK 목록, 상세 진행현황, 이슈
3. 각 모듈의 `sessions/_current.md` — 최근 세션에서 남은 작업
...
3. `sessions/_current.md` — 최근 세션 상황
...
1. `_projects/PRJ-*.md`의 01. 프로젝트 개요 → 현재 상태 요약
