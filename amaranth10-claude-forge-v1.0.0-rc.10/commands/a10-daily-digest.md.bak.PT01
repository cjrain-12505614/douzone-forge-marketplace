...
`douzone-forge/_업무산출물/보고서/일일보고/원본캐시/YYYY-MM/YYYYMMDD-{사번}.md` 로 캐싱한다.
...
3. `douzone-forge/_업무산출물/보고서/일일보고/원본캐시/YYYY-MM/YYYYMMDD-{사번}.md` 저장
...
- Chrome MCP 접근 가능
- `douzone-forge/_업무산출물/보고서/일일보고/원본캐시/` 디렉토리 쓰기 권한
