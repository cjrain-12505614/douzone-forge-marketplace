...
- `규칙/프로세스/Forge-초기화-가이드.md`(forge) (Q-4 Q-18) — 7단계 사용자 환경 셋업
- `규칙/프로세스/Forge-GitLab-운영가이드.md`(forge) — GitLab 레포 정보·user.name·배포
...
- v1.14.2 (2026-07-15) — `deliverables/` 폐기 행(#5) 제거. Q-13(2026-04-27)의 deliverables/ 폐기 결정은 V-06 Phase V-06-03(2026-05-11)에서 되돌려졌고, 2026-05-22 워크스페이스-폴더-구조-표준이 deliverables/ 를 공용 정본 루트로 확정했다. 옛 경로 경고가 정본 폴더를 오탐하고 `/dz-daily-digest` 자동 적재분을 매번 "폐기됨"이라 경고하던 자기모순 해소(structure-awareness.sh L37 동반 제거). 워크스페이스 오배치 조사 참조: `참고자료/리포트/2026-07-15-워크스페이스-오배치-정리-조사.md`.
