...
1. `프로젝트/_dashboard.md` — 전체 프로젝트 포트폴리오 (진행률, 상태, 리스크)
2. 진행 중 프로젝트의 `프로젝트/PRJ-*.md` — TASK 목록, 상세 진행현황, 이슈
3. 각 모듈의 `_개인/sessions/{대상}/_current.md` — 최근 세션에서 남은 작업
...
3. `_개인/sessions/{대상}/_current.md` — 최근 세션 상황
...
1. `프로젝트/PRJ-*.md`의 01. 프로젝트 개요 → 현재 상태 요약
