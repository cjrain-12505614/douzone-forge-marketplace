...
- **담당자 필터**: {ID}, shshkim, {ID}, {ID}, seonmyeong7047 (자동 주입)
- **서버 총 건수 / 수집 건수**: 47 / 47
- **복수 모듈 이슈**: 2건
- **미매핑 이슈**: 3건
...
| 모듈 | BE | FE | 건수 | 보기 |
|------|----|----|------|------|
| 업무관리 | 12 | 8 | 20 | `/dz-jira --read 2026-04-18/업무관리` |
| 게시판   | 5  | 4 | 9  | `/dz-jira --read 2026-04-18/게시판` |
| 법무관리 | 6  | 3 | 9  | `/dz-jira --read 2026-04-18/법무관리` |
| CRM      | 2  | 1 | 3  | `/dz-jira --read 2026-04-18/CRM` |
| 연락처   | 1  | 2 | 3  | `/dz-jira --read 2026-04-18/연락처` |
| _unmapped| 1  | 2 | 3  | `/dz-jira --read 2026-04-18/_unmapped` |
